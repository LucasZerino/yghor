  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <MetaTags>
          <title>Yghor Meira | calendário</title>
        </MetaTags>
                    ...
                    <Col lg={3}>
                      ...
                      <div id="external-events" className="mt-3">
                        <p className="text-muted">
                          Arraste o seu evento ou click no calendário
                        </p>
                        {categories &&
                            ...
                            <Row form>
                              ...
                              <Col className="col-12 mb-3">
                                ...
                                >
                                  ...
                                  <option value="bg-success">Sucesso</option>
                                  <option value="bg-primary">Primário</option>
